    ...
    transactionView(0)
{
	...
	typeWidget->addItem(tr("Proof of Stake"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint));	
    typeWidget->addItem(tr("Proof of Work"), TransactionFilterProxy::TYPE(TransactionRecord::Generated));
